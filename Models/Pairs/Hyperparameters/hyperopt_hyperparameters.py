...
from Models.variables import PAIRS_DATASET, HYPEROPT_EVALUATIONS
...
class HyperOptXgboost(TrainXgBoost):
    ...
    def objective(self, space):
        ...
        model_for_trial = xgboost.XGBClassifier(**params)
        ...
        scoring = accuracy_score(self.y_test, pred)
    ...
    def perform_hyperopt(self):
        ...
        hyperopt_model = xgboost.XGBClassifier(**best_params)
